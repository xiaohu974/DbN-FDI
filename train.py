...
# parser.add_argument('--pretrain_dir', type=str, default='workdirs/snapshots_folder/best_Epoch_ssim.pth')
...
for epoch in range(config.num_epochs):
    ...
    # epoch_losses.append((epoch_loss / 12))
